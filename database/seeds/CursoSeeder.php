    ...
    public function run()
    {
        ...
        for ($i=0; $i < 10; $i++) {
            $mate_id = \DB::table('Materia')->insertGetId(array(
                ...
                'mate_rutaarchivo' => $faker->imageUrl(640, 480),
        ...
        $this->crearComplementoTallerDiagnosticoTeorico($tall_id_diagnostico);
        $this->crearComplementoTallerDiagnosticoTeorico($tall_id_teorico);
        ...
        for ($i=0; $i < 100; $i++) {
            ...
            $tall_id = \DB::table('Taller')->insertGetId(array(
                ...
                'tall_tiempo' => $faker->date('Y-m-d H:i:s', 'now'),
                'tall_rutaarchivo' => $faker->imageUrl(640, 480),
                'tall_nombrearchivo' => $faker->word(),
                'curs_id' => $curs_id
            ));
            ...
            $preg_id = \DB::table('Pregunta')->insertGetId(array(
                ...
                'preg_porcentaje' => $faker->randomFloat(2, 0,1),
                'tall_id' =>$tall_id
            ));
        }
    }

    private function crearComplementoTallerDiagnosticoTeorico($tall_id)
    {
        $faker = Faker::create('es_ES');
        /*
         * PREGUNTA ABIERTA DEL TALLER DIAGNOSTICO O TALLER TEORICO
         */
        $preg_id = \DB::table('Pregunta')->insertGetId(array(
            'preg_texto' => "Primer pregunta del taller (abierta)",
            'preg_tipo' => "abierta",
            'preg_porcentaje' => $faker->randomFloat(2, 0,1),
            'tall_id' => $tall_id
        ));
        /*
         * PREGUNTA MULTIPLE DEL TALLER DIAGNOSTICO O TALLER TEORICO
         */
        $preg_id_multiple = \DB::table('Pregunta')->insertGetId(array(
            'preg_texto' => "Segunda pregunta del taller (multiple)",
            'preg_tipo' => "unica-multiple",
            'preg_porcentaje' => $faker->randomFloat(2, 0,1),
            'tall_id' => $tall_id
        ));
        /*
         * RESPUESTAS DE LA PREGUNTA MULTIPLE DEL TALLER DIAGNOSTICO O TALLER TEORICO
         */
        ...
        /*
         * PREGUNTA UNICA DEL TALLER DIAGNOSTICO O TALLER TEORICO
         */
        $preg_id_unica = \DB::table('Pregunta')->insertGetId(array(
            'preg_texto' => "Tercera pregunta del taller (unica)",
            'preg_tipo' => "unica-multiple",
            'preg_porcentaje' => $faker->randomFloat(2, 0,1),
            'tall_id' => $tall_id
        ));
        /*
         * RESPUESTAS DE LA PREGUNTA UNICA DEL TALLER DIAGNOSTICO O TALLER TEORICO
         */
        $remu_id = \DB::table('RespuestaMultipleUnica')->insertGetId(array(
            'remu_texto' => "Respuesta para seleccionar numero 1",
            'remu_correcta' => false,
        ...
        /*
         * PREGUNTA ARCHIVO DEL TALLER DIAGNOSTICO O TALLER TEORICO - ANDRÉS
         */
        $preg_id = \DB::table('Pregunta')->insertGetId(array(
