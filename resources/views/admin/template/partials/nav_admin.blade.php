  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="{{ route('admin.index') }}">{{ trans('messages.introduccion') }}</a></li>
	      <li><a href="{{ route('front.index') }}">{{ trans('messages.tema') }}</a></li>
        <li><a href="{{ route('')}}">{{ trans('messages.taller') }}</a></li>
        <li><a href="#"></a></li>
      </ul>
