        ...
        $('.tab-content:visible').find(".solucionar-taller-nomina").click(function(event) {
            ...
            swal({
                ...
                text: "Al enviar los datos para ser almacenados, las filas sin nombres y apellidos ni cédula serán omitidas y eliminadas de la tabla. Por favor confirme.",
                type: 'warning',
                ...
                if(option === true){
                    enviarDatosTallerNomina(botonPulsado);
                    return true;
                }else{
                    return false;
                }
        ...
        function enviarDatosTallerNomina(elemento){
