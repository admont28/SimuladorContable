...
<div class="row">
    <div class="col-lg-12 text-center">
        <button class="btn btn-primary generar-tablas-niif" data-ruta="{{ route('estudiante.curso.taller.generartablasniif', ['curs_id' => $curso->curs_id, 'tall_id' => $tallerPractico->tall_id]) }}">Generar estados financieros NIIF y guardar</button>
    </div>
</div>
