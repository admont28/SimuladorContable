                                            ...
                                            @if ($tallerPractico->tallerKardex->respuestaTallerKardexUsuarioAutenticado() === null)
                                                @for ($i = 0; $i < 2; $i++)
                                                    <tr>
                                                        ...
                                                        <td class="text-center vcenter td-valor-unitario" contenteditable="true" data-toggle="tooltip" title="Presione clic para editar.">$ 0</td>
                                                        <td class="text-center vcenter td-entradas-cantidad numero" contenteditable="true" data-toggle="tooltip" title="Presione clic para editar.">0</td>
                                                        <td class="text-center vcenter td-entradas-valor">$ 0</td>
                                                        <td class="text-center vcenter td-salidas-cantidad numero" contenteditable="true" data-toggle="tooltip" title="Presione clic para editar.">0</td>
