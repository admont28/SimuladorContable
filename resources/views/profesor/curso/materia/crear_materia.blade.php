...
@section('content')
    <div class="row">
        <form class="form-horizontal" action="{{ route('profesor.curso.materia.crear.post', ['curs_id' => $curso->curs_id ]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group {{ $errors->has('mate_nombre') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" id="mate_nombre" placeholder="Ingrese el nombre de la materia" name="mate_nombre" value="{{ old('mate_nombre') }}" autofocus="autofocus" required="required">
            ...
            <div class="form-group {{ $errors->has('mate_tema') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    <textarea type="text" class="form-control" id="mate_tema" placeholder="Ingrese el tema de la materia" name="mate_tema" rows="5" required="required">{{ old('mate_tema') }}</textarea>
            ...
            <div class="form-group {{ $errors->has('mate_rutaarchivo') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-10">
                    <input type="file" class="form-control" id="mate_rutaarchivo" placeholder="ruta del archivo" name="mate_rutaarchivo" value="{{ old('mate_rutaarchivo') }}" required="required">
