...
@section('content')
    <form class="form-horizontal" action="{{ route('profesor.curso.taller.tarifa.crear.post',['curs_id'=>$taller->curs_id,'tall_id'=>$taller->tall_id]) }}" method="post">
        ...
        <div class="form-group {{ $errors->has('nombre_tarifa') ? ' has-error' : '' }}">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" placeholder="Ingrese el nombre de la tarifa" name="nombre_tarifa" value="{{ old('nombre_tarifa') }}">
        ...
        <div class="form-group {{ $errors->has('valor_tarifa') ? ' has-error' : '' }}">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" placeholder="Ingrese el valor de la tarifa" name="valor_tarifa" value="{{ old('valor_tarifa') }}">
