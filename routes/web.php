...
Route::group(['prefix' => 'estudiante', 'middleware' => ['auth','estudiante'] ], function(){
    ...
    */
    ...
    Route::post('/curso/{curs_id}/taller/{tall_id}/generar-tablas-niif', 'TallerController@generarTablasNiifPost')->name('estudiante.curso.taller.generartablasniif');
    /*
    |--------------------------------------------------------------------------
...
Route::group(['prefix' => 'profesor', 'middleware' => ['auth','profesor']], function(){
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::get('/curso/{curs_id}/taller/{tall_id}/usuarios-que-han-respondido-el-taller', 'TallerController@mostrarUsuariosTaller')->name('profesor.curso.taller.usuarios');
